...
using MessagingService.Service.Bootstrapper;
...
namespace MessagingService.Service
{
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Messaging Service API v1");
            });
        }
        #endregion
        ...
        public static IContainer GetConfiguredContainer(IServiceCollection services, IHostingEnvironment hostingEnvironment)
        {
            ...
            container.Configure(config =>
            {
                ...
                {
                    config.AddRegistry<IntegrationTestRegistry>();
                }
        ...
        private static void ConfigureMiddlewareServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Messaging Service API", Version = "v1" });
            });
        }
        #endregion
